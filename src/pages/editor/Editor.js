...
import {updateFrontCanvasShape, updateBackCanvasShape, updateCanvasMode} from '../../store/redux/actions/canvas';
...
const Editor = forwardRef((props, ref) => {
    ...
    const [shapeCounter, setShapeCounter] = useState(
        frontCanvasShape === 'square'
            ? 0
            : frontCanvasShape === 'triangle'
                ? 1
                : frontCanvasShape === 'circle'
                    ? 2
                    : 0,
    );
    ...
    const changeShape = () => {
        if (shapeCounter == 2) {
            ...
            switch (canvasMode) {
                case 'front':
                    dispatch(updateFrontCanvasShape('square'));
                    break;
                case 'back':
                    dispatch(updateBackCanvasShape('square'));
                    break;
                default:
                    break;
            }
            ...
            switch (canvasMode) {
                case 'front':
                    dispatch(updateFrontCanvasShape('triangle'));
                    break;
                case 'back':
                    dispatch(updateBackCanvasShape('triangle'));
                    break;
                default:
                    break;
            }
            ...
            switch (canvasMode) {
                case 'front':
                    dispatch(updateFrontCanvasShape('circle'));
                    break;
                case 'back':
                    dispatch(updateBackCanvasShape('circle'));
                    break;
                default:
                    break;
            }
                ...
                /> */}
                    ...
                    >
                        <Card
                            ...
                            style={{borderRadius: frontCanvasShape === 'triangle' || backCanvasShape === 'triangle' ? '0px' : '1rem'}}
                        >
